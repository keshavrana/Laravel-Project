                ...
                <div class="card">
                    <div class="card-header msg_head">
                        <div class="d-flex bd-highlight">
                            <div class="img_cont">
                                <img src="{{ asset('assets/images/robot.jpg') }}" class="rounded-circle user_img">
                    ...
                    <div class="card-footer">
                        <div class="input-group">
                            ...
                            <textarea name="query" class="form-control type_msg" placeholder="Type your message..."></textarea>
                            <div class="input-group-append">
...
<script>
    ...
    $('.send_btn').click(function(e) {
        $('#user_admin').html('');
        $('#openaians').html('');
        let topic = $('.type_msg').val();
        var datetime = moment(new Date()).format("hh:mm A");
        if (topic == null || topic == '') {
            alert("Please Enter Your Query");
        } else {
            $('#user_admin').append(
                '<div class="msg_cotainer_send" id="user_admin">' + topic +
                '<span class="msg_time_send">' + datetime +
                ' Today</span></div>');
            $('.type_msg').val('');
